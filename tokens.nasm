...
tokentbl                db          4,2,"ABS(",0x03,0x00
                        ...
                        db          4,2,"SAVE",0x03,0x85
                        db          4,2,"SEEK",0x03,0x86
                        db          3,2,"SHL",0x03,0x87
                        db          3,2,"SHR",0x03,0x88
                        db          4,2,"SIN(",0x03,0x89
                        db          4,2,"SQR(",0x03,0x8a
                        db          5,2,"SQRT(",0x03,0x8b
                        db          4,2,"STOP",0x03,0x8c
                        db          5,2,"STR$(",0x03,0x8d
                        db          3,2,"SUB",0x03,0x8e
                        db          3,2,"SYS",0x03,0x8f
                        db          2,2,"TI",0x03,0x90
                        db          3,2,"TI$",0x03,0x91
                        db          5,2,"TIME$",0x03,0x92
                        db          5,2,"TIMER",0x03,0x93
                        db          2,2,"TO",0x03,0x94
                        db          5,2,"TRACE",0x03,0x95
                        db          4,2,"TYPE",0x03,0x96
                        db          4,2,"UNI(",0x03,0x97
                        db          5,2,"UNI$(",0x03,0x98
                        db          6,2,"UNLESS",0x03,0x99
                        db          5,2,"UNTIL",0x03,0x9a
                        db          5,2,"USING",0x03,0x9b
                        db          4,2,"VAL(",0x03,0x9c
                        db          6,2,"VTAB$(",0x03,0x9d
                        db          4,2,"WEND",0x03,0x9e
                        db          5,2,"WHILE",0x03,0x9f
                        db          4,2,"XNOR",0x03,0xa0
                        db          3,2,"XOR",0x03,0xa1
