...
tokentbl                db          4,2,"ABS(",0x03,0x00
                        ...
                        db          4,2,"CHAR",0x03,0x14
                        db          5,2,"CLEAR",0x03,0x15
                        db          5,2,"CLOSE",0x03,0x16
                        db          3,2,"CLS",0x03,0x17
                        db          5,2,"COLOR",0x03,0x18
                        db          4,2,"CONT",0x03,0x19
                        db          4,2,"COS(",0x03,0x1a
                        db          4,2,"DATA",0x03,0x1b
                        db          5,2,"DATE$",0x03,0x1c
                        db          9,2,"DATETIME$",0x03,0x1d
                        db          5,2,"DEC$(",0x03,0x1e
                        db          3,2,"DEF",0x03,0x1f
                        db          6,2,"DELETE",0x03,0x20
                        db          3,2,"DIM",0x03,0x21
                        db          2,2,"DO",0x03,0x22
                        db          4,2,"DOWN",0x03,0x23
                        db          6,2,"DOWNTO",0x03,0x24
                        db          7,2,"DYNAMIC",0x03,0x25
                        db          4,2,"EACH",0x03,0x26
                        db          4,2,"EDIT",0x03,0x27
                        db          4,2,"ELSE",0x03,0x28
                        db          3,2,"END",0x03,0x29
                        db          3,2,"EQV",0x03,0x2a
                        db          5,2,"ERASE",0x03,0x2b
                        db          3,2,"ERL",0x03,0x2c
                        db          4,2,"ERR$",0x03,0x2d
                        db          5,2,"ERROR",0x03,0x2e
                        db          4,2,"EVER",0x03,0x2f
                        db          5,2,"EVERY",0x03,0x30
                        db          4,2,"EXIT",0x03,0x31
                        db          4,2,"EXP(",0x03,0x32
                        db          5,2,"FILES",0x03,0x33
                        db          6,2,"FLOOR(",0x03,0x34
                        db          2,2,"FN",0x03,0x35
                        db          3,2,"FOR",0x03,0x36
                        db          7,2,"FOREACH",0x03,0x37
                        db          7,2,"FOREVER",0x03,0x38
                        db          4,2,"FUNC",0x03,0x39
                        db          8,2,"FUNCTION",0x03,0x3a
                        db          3,2,"GET",0x03,0x3b
                        db          2,2,"GO",0x03,0x3c
                        db          5,2,"GOSUB",0x03,0x3d
                        db          4,2,"GOTO",0x03,0x3e
                        db          5,2,"HEX$(",0x03,0x3f
                        db          4,2,"HTAB",0x03,0x40
                        db          5,2,"HTAB(",0x03,0x41
